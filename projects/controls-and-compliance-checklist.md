...
I personally believe we first need to focus on getting preventative controls in line. Preventative controls are the first line of defense, so it will aid in reducing risks to assets insurmountably.